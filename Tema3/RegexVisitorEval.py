...
class RegexVisitorShow(RegexVisitor):
    ...
    def visitExpr(self, ctx:RegexParser.ExprContext):
        ...
        if(expr2):
            ...
            delta = deltaAux1 + [(0, "eps", initialState2)] + [(finalState1, "eps", finalState)] 
                            + deltaAux2 + [(finalState2, "eps", finalState)]
    ...
    def visitAnd_expr(self, ctx:RegexParser.And_exprContext):
        ...
        if(expr2):
            ...
            return NFA(numberOfStates, finalState2, delta)
        else:
            return self.visit(expr1)
    ...
    def visitStar_expr(self, ctx:RegexParser.Star_exprContext):
        ...
        if(expr2):
            ...
            delta = delta + [(finalState1, "eps", initialState1)] + 
                    [(finalState1, "eps", finalState1 + 1)] + [(0, "eps", finalState1 + 1)]
            return NFA(numberOfStates, finalState, delta)
        else: 
            return self.visit(expr1)
